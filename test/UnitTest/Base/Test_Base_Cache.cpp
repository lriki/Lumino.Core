...
{
	g_count = 0;
	RefPtr<CacheManager> manager(LN_NEW CacheManager(2, 0));
...
{
	g_count = 0;
	RefPtr<CacheManager> manager(LN_NEW CacheManager(2, 1));	// 1byte しかキャッシュに置けない
...
{
	RefPtr<CacheManager> manager(LN_NEW CacheManager(0, 0));
