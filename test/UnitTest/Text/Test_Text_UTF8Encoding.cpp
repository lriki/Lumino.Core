...
{
	GCPtr<Decoder> decoder = Encoding::GetUTF8Encoding()->CreateDecoder();
	...
	ASSERT_EQ(1, bytesUsed);		// 1バイト消費している
...
{
	GCPtr<Encoder> encoder = Encoding::GetUTF8Encoding()->CreateEncoder();
