...
TEST_F(Test_Text_EncodingDetector, UTF8BOM)
{
	...
	ByteBuffer buf1(FileUtils::ReadAllBytes(LN_TEST_GET_FILE_PATH("TestData/UTF8BOM.txt")));
	ByteBuffer buf2(FileUtils::ReadAllBytes(LN_TEST_GET_FILE_PATH("TestData/UTF16LittleBOM.txt")));
	ByteBuffer buf3(FileUtils::ReadAllBytes(LN_TEST_GET_FILE_PATH("TestData/UTF16BigBOM.txt")));
	ByteBuffer buf4(FileUtils::ReadAllBytes(LN_TEST_GET_FILE_PATH("TestData/UTF32LittleBOM.txt")));
	ByteBuffer buf5(FileUtils::ReadAllBytes(LN_TEST_GET_FILE_PATH("TestData/UTF32BigBOM.txt")));
...
{
	EncodingDetector detector;
	ByteBuffer buf1(FileUtils::ReadAllBytes(LN_TEST_GET_FILE_PATH("TestData/ConvertTable_SJIS_test.txt")));
